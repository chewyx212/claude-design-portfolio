...
const STYLE = `
  ...
  .twk-fab{position:fixed;right:16px;bottom:16px;z-index:2147483645;
    ...
    letter-spacing:.03em;padding:10px 14px;cursor:default}
  .twk-fab:hover{background:rgba(250,249,247,1)}
`;
...
export function TweaksPanel({
  ...
  return (
    <>
      <style>{STYLE}</style>
      {!open && (
        <button className="twk-fab" onClick={onToggle}>⚙ Tweaks</button>
      )}
      {open && (
        <div
          ref={dragRef}
